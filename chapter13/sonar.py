...
def makeMove(board, chests, x, y):
    ...
    # Otherwise, return the string from the result of this move.
    ...
    for cx, cy in chests:
        ...
        if smallestDistance == 0:
            ...
            if smallestDistance < 10:
                ...
                return 'Treasure deteted at a distance of %s from the sonar device.' % (smallestDistance)
            else:
                board[x][y] = '0'
...
def showInstructions():
    ...
    is to find the three sunken treasure chests that are lurking in the part of the ocean you are in and collect them.
    ...
    For example, the d below marks where the device was dropped, and the 2's represent distances of 2 away from the device. The 4's represent distances of 4 away from the device.
...
while True:
    ...
    while sonarDevices > 0:
        ...
        x, y = enterPlayerMove()
        previousMoves.append([x,y]) # we must track all move so that sonar devies can be updates.
    ...
    if sonarDevices ==0:
        print('We\'ve run out of sonar devices! Now e have to turn the ship around and head')
